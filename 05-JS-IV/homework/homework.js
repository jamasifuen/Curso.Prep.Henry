...
function agregarMetodoCalculoDescuento(producto) {
  ...
  producto.calcularPrecioDescuento=function(){
    precioDescuento=producto.porcentajeDeDescuento*producto.precio;
    precioConDescuento=producto.precio-precioDescuento
  ...
  {
    precioDescuento=producto.porcentajeDeDescuento*producto.precio;
    producto.precio=producto.precio-precioDescuento
    return producto;
  }
